...
def AircraftManager_SEI(ACI,flow):
    ...
    if ACI.prop.bool:
        ...
        AC.prop.vix = np.zeros(AC.wing.getR()+AC.htail.getR()+AC.vtail.getR(),dtype = float);
        AC.prop.viy = np.zeros(AC.wing.getR()+AC.htail.getR()+AC.vtail.getR(),dtype = float);
        AC.prop.viz = np.zeros(AC.wing.getR()+AC.htail.getR()+AC.vtail.getR(),dtype = float);
    return AC;
